...
<div class="fondo version-escritorio" style="background-image:url('<?php bloginfo( 'wpurl' ); ?>/wp-content/themes/cargoex-theme-v1-0/core/images/Web/img/contenedor-contacto.png'); background-size:cover; background-position:center; width:100%; height:100vh;">
